...
var tmpls = map[string]string{"field.tmpl": `{{initialCap .Name}} {{.Type}} {{jsonTag .Name .Required}} {{asComment .Definition.Description}}
`,
...
func ({{firstLowered .Name}} *{{.Name}}) Validate() error {
