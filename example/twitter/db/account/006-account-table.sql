...
CREATE TABLE "account"."account" (
    ...
    "email_status_constant" "account_email_status_constant_enum" DEFAULT "notVerified",
    ...
    "password_status_constant" "account_password_status_constant_enum" DEFAULT "valid",
    "profile_id" BIGINT
        CONSTRAINT "check_account_profile_id_gte_0" CHECK ("profile_id" >= 0.000000),
    "salt" VARCHAR (255) COLLATE "default",
    "status_constant" "account_status_constant_enum" DEFAULT "registered",
